...
export const MyRiDeleteBinLine = () => {
  return <RiDeleteBinLine></RiDeleteBinLine>;
};
...
export const MyCiEdit = () => {
  return <CiEdit></CiEdit>;
};
export const MyBiMinus = () => {
  return <BiMinus></BiMinus>;
};
export const MyCgArrowLongRight = () => {
  return <CgArrowLongRight></CgArrowLongRight>;
};
export const MyAiFillCheckCircle = () => {
  return <AiFillCheckCircle></AiFillCheckCircle>;
};
